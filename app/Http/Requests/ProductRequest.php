...
class ProductRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'sizes.*.max' => 'Size may not be greater than 50 characters.',
            'status.integer' => 'Status must be a number.',
            'status.min' => 'Status must be at least 0.',
            'status.max' => 'Status may not be greater than 1.',
            'slug.string' => 'URL handle must be a string.',
            'slug.max' => 'URL handle may not be greater than 255 characters.',
            'slug.unique' => 'This URL handle is already in use.',
            'meta_title.string' => 'Page title must be a string.',
            'meta_title.max' => 'Page title may not be greater than 255 characters.',
