...
class CheckoutRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'billing_address_line1' => 'required_if:billing_same_as_shipping,1|nullable|string|max:255',
            'billing_address_line2' => 'nullable|string|max:255',
            'billing_city'          => 'required_if:billing_same_as_shipping,1|nullable|string|max:100',
            'billing_state'         => 'required_if:billing_same_as_shipping,1|nullable|string|max:100',
            'billing_country'       => 'required_if:billing_same_as_shipping,1|nullable|string|max:100',
            'billing_pincode'       => 'required_if:billing_same_as_shipping,1|nullable|string|max:10',
